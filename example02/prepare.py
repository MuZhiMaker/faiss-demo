...
if myMode == '1':
    ...
    if os.path.exists('/Users/lijunjun/PycharmProjects/faiss-demo/example02/my.index'):
        ...
        faiss.write_index(index, '/Users/lijunjun/PycharmProjects/faiss-demo/example02/my.index')
