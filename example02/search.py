...
startTime = time.time()
# 读取查询关键字文件
with open('/Users/lijunjun/PycharmProjects/faiss-demo/example02/search.txt', 'r', encoding='utf-8') as f:
...
with open("/Users/lijunjun/PycharmProjects/faiss-demo/example02/data/output/result.txt", "w", encoding="utf-8") as f:
    f.write("\n\n".join(results))
